export default {
  ...
  payments: {
    ...
    notifications: {
      ...
      refundBulkMessage: 'Refunding selected paymentsâ€¦',
      refundTitle: 'Refund',
    ...
    table: {
      ...
      filters: {
        search: 'Search',
        searchPlaceholder: 'Payment ID, descriptionâ€¦',
        status: 'Status',
