export default {
  ...
  photoEvolution: {
    ...
    subtitle: 'Monitor body changes through photos linked with key nutrition and measurement indicators.',
    actions: {
      refresh: 'Reload',
    ...
    form: {
      title: 'Register new progress',
      editTitle: 'Update progress entry',
      helper: 'Combine anthropometric indicators, nutrition data, and the corresponding photo to follow evolution over time.',
      fields: {
