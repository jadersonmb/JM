...
const metrics = computed(() => [
  { label: 'Active users', value: '10', hint: 'Live data will appear once connected.', icon: UsersIcon },
  { label: 'New signups', value: '100', hint: 'Pulled from /api/users analytics endpoint.', icon: ChartBarSquareIcon },
  { label: 'System uptime', value: '99.9%', hint: 'Managed via platform monitoring.', icon: ShieldCheckIcon },
  { label: 'Your role', value: auth.user?.role ?? 'Pending login', hint: auth.user?.email ?? 'Pending login', icon: BoltIcon },
]);
