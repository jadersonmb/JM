...
export const fetchWhatsAppMessages = (params) => api.get('/api/v1/whatsapp/messages', { params });
export const fetchNutritionDashboard = (params) => api.get('/api/v1/whatsapp/dashboard', { params });
