...
public final class EducationLevelSpecification {

    private EducationLevelSpecification() {
    }

    public static Specification<EducationLevel> search(String name, String code, String language) {
