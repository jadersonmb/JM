...
CREATE INDEX IF NOT EXISTS idx_payment_cards_default ON payment_cards (customer_id, is_default DESC);
...
CREATE TABLE IF NOT EXISTS payments_recurring (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_payments_recurring_customer FOREIGN KEY (customer_id) REFERENCES user_entity (id),
