...
SELECT UUID(), 'ROLE_ANALYTICS_READ', 'View analytics dashboards', a.id, o.id
FROM actions a
...
-- Anamnesis CRUD
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_ANAMNESIS_CREATE', 'Create anamnesis records', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_ANAMNESIS_READ', 'View anamnesis records', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'ANAMNESIS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_ANAMNESIS_UPDATE', 'Update anamnesis records', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'ANAMNESIS'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_ANAMNESIS_DELETE', 'Delete anamnesis records', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'ANAMNESIS'
...
-- Cloud storage
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_CLOUD_STORAGE_CREATE', 'Upload files to Cloudflare storage', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_CLOUD_STORAGE_READ', 'Download or list Cloudflare files', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'CLOUD_STORAGE'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_CLOUD_STORAGE_DELETE', 'Delete Cloudflare files', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'CLOUD_STORAGE'
WHERE a.name = 'EXCLUIR'
...
-- Diet plans
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_DIETS_CREATE', 'Create diet plans', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_DIETS_READ', 'View diet plans', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'DIETS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_DIETS_UPDATE', 'Update diet plans', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'DIETS'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_DIETS_DELETE', 'Delete diet plans', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'DIETS'
WHERE a.name = 'EXCLUIR'
...
-- Exercises
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_EXERCISES_CREATE', 'Create exercises', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_EXERCISES_READ', 'View exercises', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'EXERCISES'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_EXERCISES_UPDATE', 'Update exercises', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'EXERCISES'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_EXERCISES_DELETE', 'Delete exercises', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'EXERCISES'
WHERE a.name = 'EXCLUIR'
...
-- Foods
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_FOODS_READ', 'View food catalog', a.id, o.id
FROM actions a
...
-- Google storage
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOOGLE_STORAGE_CREATE', 'Upload files to Google Storage', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOOGLE_STORAGE_READ', 'Download files from Google Storage', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOOGLE_STORAGE'
WHERE a.name = 'CONSULTAR'
...
-- AI operations
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_AI_OPERATIONS_EXECUTE', 'Execute AI service operations', a.id, o.id
FROM actions a
...
-- Goals
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOALS_CREATE', 'Create nutrition goals', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOALS_READ', 'View nutrition goals', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOALS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOALS_UPDATE', 'Update nutrition goals', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOALS'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOALS_DELETE', 'Delete nutrition goals', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOALS'
WHERE a.name = 'EXCLUIR'
...
-- Goal templates
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOAL_TEMPLATES_CREATE', 'Create goal templates', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOAL_TEMPLATES_READ', 'View goal templates', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOAL_TEMPLATES'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOAL_TEMPLATES_UPDATE', 'Update goal templates', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOAL_TEMPLATES'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_GOAL_TEMPLATES_DELETE', 'Delete goal templates', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'GOAL_TEMPLATES'
WHERE a.name = 'EXCLUIR'
...
-- Ollama operations
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_OLLAMA_EXECUTE', 'Execute Ollama operations', a.id, o.id
FROM actions a
...
-- Payments
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENTS_CREATE', 'Create payment operations', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENTS_READ', 'View payments', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PAYMENTS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENTS_UPDATE', 'Update payments', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PAYMENTS'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENTS_DELETE', 'Cancel or delete payments', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PAYMENTS'
WHERE a.name = 'EXCLUIR'
...
-- Payment methods
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENT_METHODS_CREATE', 'Create payment methods', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENT_METHODS_READ', 'View payment methods', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PAYMENT_METHODS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENT_METHODS_DELETE', 'Delete payment methods', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PAYMENT_METHODS'
WHERE a.name = 'EXCLUIR'
...
-- Payment plans
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PAYMENT_PLANS_READ', 'View payment plans', a.id, o.id
FROM actions a
...
-- Photo evolution
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PHOTO_EVOLUTION_CREATE', 'Create photo evolution entries', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PHOTO_EVOLUTION_READ', 'View photo evolution entries', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PHOTO_EVOLUTION'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PHOTO_EVOLUTION_UPDATE', 'Update photo evolution entries', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PHOTO_EVOLUTION'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_PHOTO_EVOLUTION_DELETE', 'Delete photo evolution entries', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'PHOTO_EVOLUTION'
WHERE a.name = 'EXCLUIR'
...
-- Reference data read
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REFERENCE_DATA_READ', 'Access reference lookup data', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REFERENCE_MANAGEMENT_READ', 'View administrative reference data', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REFERENCE_MANAGEMENT_CREATE', 'Create administrative reference data', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REFERENCE_MANAGEMENT'
WHERE a.name = 'INSERIR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REFERENCE_MANAGEMENT_UPDATE', 'Update administrative reference data', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REFERENCE_MANAGEMENT'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REFERENCE_MANAGEMENT_DELETE', 'Delete administrative reference data', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REFERENCE_MANAGEMENT'
WHERE a.name = 'EXCLUIR'
...
-- Reminders
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REMINDERS_CREATE', 'Create reminders', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REMINDERS_READ', 'View reminders', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REMINDERS'
WHERE a.name = 'CONSULTAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REMINDERS_UPDATE', 'Update reminders', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REMINDERS'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_REMINDERS_DELETE', 'Delete reminders', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'REMINDERS'
WHERE a.name = 'EXCLUIR'
...
-- Units of measure
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_UNITS_READ', 'View measurement units', a.id, o.id
FROM actions a
...
-- User settings
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_USER_SETTINGS_READ', 'View user settings', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_USER_SETTINGS_UPDATE', 'Update user settings', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'USER_SETTINGS'
WHERE a.name = 'ALTERAR'
...
-- WhatsApp management
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_WHATSAPP_MANAGEMENT_CREATE', 'Create WhatsApp nutrition entries', a.id, o.id
FROM actions a
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_WHATSAPP_MANAGEMENT_UPDATE', 'Update WhatsApp nutrition entries', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'WHATSAPP_MANAGEMENT'
WHERE a.name = 'ALTERAR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_WHATSAPP_MANAGEMENT_DELETE', 'Delete WhatsApp nutrition entries', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'WHATSAPP_MANAGEMENT'
WHERE a.name = 'EXCLUIR'
...
INSERT INTO permissions (id, code, description, action_id, object_id)
SELECT UUID(), 'ROLE_WHATSAPP_MANAGEMENT_READ', 'View WhatsApp nutrition data', a.id, o.id
FROM actions a
         JOIN objects o ON o.name = 'WHATSAPP_MANAGEMENT'
WHERE a.name = 'CONSULTAR'
